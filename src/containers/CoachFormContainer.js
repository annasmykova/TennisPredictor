...
const handleGetSearchData = (value, dispatch) => {
  getSearchList()
}
...
export default connect(state => ({ initialValues: fromAuth.getUser(state) }))(CoachFormContainer)
